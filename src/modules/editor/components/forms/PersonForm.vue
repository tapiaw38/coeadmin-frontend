<template>
    ...
    >
      ...
      <div class="form-control">
        ...
        <div 
        class="alert"
        v-if="getPersonByDocument(personForm.document)"
        >
          <p>
            El documento {{ getPersonByDocument(personForm.document).document }} ya se encuentra registrado.
          </p>
        </div>
      </div>
      <div class="form-control">
      ...
      <div class="form-control">
        ...
        <select 
        v-model="personForm.location.district"
        >
      ...
      <div class="form-control">
        ...
        <input 
        type="text"
        v-model="personForm.location.address"
        required
        />
      </div>
